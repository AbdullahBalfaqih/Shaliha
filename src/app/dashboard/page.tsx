            ...
            <DialogContent dir="rtl" className="sm:max-w-md">
                ...
                <div className="space-y-4 text-right py-4">
                    <div className="space-y-2">
                        ...
                        <p className="font-bold text-muted-foreground"> <span className="font-bold text-muted-foreground">التاريخ:</span> {booking.booking_date}</p>
                        <p className="font-bold text-muted-foreground"> <span className="font-bold text-muted-foreground">الفترة:</span> {booking.period === 'full_day' ? 'يوم كامل' : (booking.period === 'morning' ? 'صباحي' : 'مسائي')}</p>
